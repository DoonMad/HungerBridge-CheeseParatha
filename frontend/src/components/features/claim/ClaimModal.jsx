import { X, CheckCircle, MapPin, AlertCircle, Truck, Store, Bike } from 'lucide-react';
      ...
      <div className="relative bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            {deliveryMethod === 'volunteer' && (
              <div className="mt-4 flex items-start gap-3 bg-blue-50 text-blue-800 p-4 rounded-xl text-sm leading-relaxed border border-blue-100">
                <AlertCircle size={20} className="shrink-0 mt-0.5 text-blue-500" />
                <p>
                  A nearby volunteer will be automatically dispatched to pick up the food from the donor and deliver it directly to your registered NGO address.
                </p>
              </div>
            )}
